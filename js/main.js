...
function initDarkMode() {
    ...
    if (localStorage.getItem('travelgo_darkmode') === 'true') {
    ...
    btn.addEventListener('click', function () {
        ...
        localStorage.setItem('travelgo_darkmode', isDark);
    });
}

// ========================================
// Feature 3: Page Loading Spinner
// ========================================

function initPageLoader() {
    const loader = document.createElement('div');
    loader.className = 'page-loader';
    loader.innerHTML = '<div class="loader-spinner"></div><div class="loader-text">Loading TravelGo...</div>';
...
// Call loader immediately (before DOMContentLoaded)
initPageLoader();

// ========================================
// Feature 4: Scroll Reveal Animations
// ========================================

function initScrollReveal() {
    const revealElements = document.querySelectorAll('.destination-card, .hotel-card, .tour-card, .testimonial-card, .section-header, .contact-wrapper');
...
// ========================================
// Feature 5: Destination Search/Filter
// ========================================

function initDestinationSearch() {
    const destSection = document.querySelector('#destinations .section-header');
    if (!destSection) return;

    const searchHTML = document.createElement('div');
    searchHTML.className = 'destination-search';
    searchHTML.innerHTML = '<div class="search-input-wrapper"><i class="fas fa-search"></i><input type="text" id="destSearchInput" placeholder="Search destinations by name, location, or price..."></div>';

    destSection.parentNode.insertBefore(searchHTML, document.querySelector('.destinations-grid'));

    document.getElementById('destSearchInput').addEventListener('input', function () {
        const query = this.value.toLowerCase().trim();
        document.querySelectorAll('.destinations-grid .destination-card').forEach(function (card) {
            const name = (card.dataset.name || '').toLowerCase();
            const type = (card.dataset.type || '').toLowerCase();
            const text = card.textContent.toLowerCase();
            if (!query || name.includes(query) || type.includes(query) || text.includes(query)) {
                card.style.display = '';
            } else {
                card.style.display = 'none';
            }
...
// ========================================
// Feature 6: Testimonials Section
// ========================================
    ...
    section.innerHTML = `
        <div class="container">
            <div class="section-header">
                ...
                <p>Real experiences from happy travelers around the world</p>
            </div>
            <div class="testimonials-carousel" id="testimonialsCarousel">
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">"TravelGo made our Goa trip absolutely seamless! From booking flights to finding the perfect beachside resort, everything was handled perfectly. Highly recommended!"</p>
                    <div class="testimonial-author">
                        <img src="https://ui-avatars.com/api/?name=Priya+Sharma&background=4f46e5&color=fff&size=80" alt="Priya Sharma">
                ...
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">"The Ladakh Adventure tour was the best decision we ever made. The team took care of every single detail. The camping under the stars at Pangong Lake was magical!"</p>
                    <div class="testimonial-author">
                        <img src="https://ui-avatars.com/api/?name=Rahul+Patel&background=06b6d4&color=fff&size=80" alt="Rahul Patel">
                        <div class="testimonial-author-info">
                            <h4>Rahul Patel</h4>
                            <p>Ahmedabad, India</p>
                        </div>
                ...
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">"Booked the Maldives package for our anniversary and it was absolutely stunning. The 5-star resort, the crystal clear water — everything exceeded our expectations!"</p>
                    <div class="testimonial-author">
                        <img src="https://ui-avatars.com/api/?name=Anita+Desai&background=f59e0b&color=fff&size=80" alt="Anita Desai">
                        <div class="testimonial-author-info">
                            <h4>Anita Desai</h4>
                            <p>Delhi, India</p>
                        </div>
                ...
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">"The Golden Triangle Tour was incredibly well organized. Our guide was knowledgeable and the hotels were top-notch. Will definitely book with TravelGo again!"</p>
                    <div class="testimonial-author">
                        <img src="https://ui-avatars.com/api/?name=Vikram+Singh&background=10b981&color=fff&size=80" alt="Vikram Singh">
                        <div class="testimonial-author-info">
                            <h4>Vikram Singh</h4>
                            <p>Jaipur, India</p>
                        </div>
                ...
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">"Kerala backwater cruise was a dream come true. The houseboat experience, authentic food, and Ayurveda spa — everything was perfectly curated by TravelGo!"</p>
                    <div class="testimonial-author">
                        <img src="https://ui-avatars.com/api/?name=Meera+Nair&background=ef4444&color=fff&size=80" alt="Meera Nair">
                        <div class="testimonial-author-info">
                            <h4>Meera Nair</h4>
                            <p>Bangalore, India</p>
                        </div>
            ...
            <div class="testimonial-nav">
                <button onclick="scrollTestimonials(-1)" title="Previous"><i class="fas fa-chevron-left"></i></button>
                <button onclick="scrollTestimonials(1)" title="Next"><i class="fas fa-chevron-right"></i></button>
            </div>
        </div>
    `;
...
function scrollTestimonials(direction) {
    ...
    if (carousel) {
        carousel.scrollBy({ left: direction * 380, behavior: 'smooth' });
    }
}
...
function initCookieConsent() {
    if (localStorage.getItem('travelgo_cookies_accepted')) return;

    const banner = document.createElement('div');
    banner.className = 'cookie-banner';
    banner.innerHTML = `
        <p><i class="fas fa-cookie-bite" style="margin-right: 8px; color: #f59e0b;"></i>
        We use cookies to enhance your browsing experience and provide personalized travel recommendations. 
        By continuing to use TravelGo, you agree to our <a href="#">Cookie Policy</a>.</p>
        <div class="cookie-actions">
            <button class="btn btn-outline" onclick="declineCookies()" style="color: white; border-color: rgba(255,255,255,0.3);">Decline</button>
...
function acceptCookies() {
    localStorage.setItem('travelgo_cookies_accepted', 'true');
...
function declineCookies() {
    localStorage.setItem('travelgo_cookies_accepted', 'declined');
    const banner = document.querySelector('.cookie-banner');
    if (banner) {
        banner.classList.remove('visible');
        setTimeout(function () { banner.remove(); }, 400);
